{* PowerDNS Premium – Service Overview Page
   Default landing page for the DNS hosting service.
   Clients navigate to the DNS manager from here.
*}
...
<div class="pdns-overview">
  ...
  {if !$licensed}
    <div class="alert alert-warning">
      ...
      Record management is currently limited. Please contact support.
    </div>
  {/if}
  ...
  <div class="pdns-overview-header">
    <div class="pdns-overview-zone">
      ...
      <div>
        ...
        {if $allowDNSSEC}
          &nbsp;<span class="text-muted"><i class="fa fa-lock"></i> DNSSEC available</span>
        {/if}
      </div>
    </div>
    ...
    <div class="col-sm-4">
      <div class="panel panel-default pdns-card">
        <div class="panel-body text-center">
          ...
          <a href="{$manageUrl|escape}#tab-records" class="btn btn-default btn-block">
    ...
    <div class="col-sm-4">
      ...
      <div class="panel panel-default pdns-card">
        <div class="panel-body text-center">
          ...
          <a href="{$manageUrl|escape}#tab-dnssec" class="btn btn-default btn-block">
      ...
      <div class="panel panel-default pdns-card">
        <div class="panel-body text-center">
          ...
          <a href="{$manageUrl|escape}#tab-history" class="btn btn-default btn-block">
